...
def main():
    ...
    class Spaceship(pygame.sprite.Sprite):
        ...
        def update(self):
            ...
            # Draw health bar below the spaceship with increased size
            health_bar_width = self.rect.width * 1.5  # Increase width for better visibility
            health_bar_height = 20  # Increased height for a more prominent look
            ...
            if self.health_remaining > 0:
                pygame.draw.rect(screen, green,
                                 (self.rect.x - (health_bar_width - self.rect.width) / 2,
                                  self.rect.bottom + 10,
                                  int(health_bar_width * (self.health_remaining / self.health_start)),
                                  health_bar_height))
